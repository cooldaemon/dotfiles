---
description: "Create implementation plan with EARS-format acceptance criteria using a subagent"
---

I'll use the planner subagent to create a comprehensive implementation plan.
...
## Next Commands
After planning:
- `/update-claude-config` - Execute the plan (for config-only changes: commands, agents, skills, docs)
- `/tdd` - Implement with test-driven development (for plans with executable code)

...
syn match	schemeError	oneline    !#\\newline[^ \t\[\]()";]\+!
    ...
    syn keyword schemeExtFunc c-wrapper
    syn keyword schemeExtFunc c-wrapper.c-ffi
    syn keyword schemeExtFunc c-wrapper.c-parser
    syn keyword schemeExtFunc c-wrapper.config
    syn keyword schemeExtFunc c-wrapper.objc-ffi
    syn keyword schemeExtFunc c-wrapper.stubgen
    syn keyword schemeExtFunc compat.jfilter
    syn keyword schemeExtFunc compat.norational
    syn keyword schemeExtFunc compat.stk
    syn keyword schemeExtFunc dbd.mysql
    ...
    syn keyword schemeExtFunc dbm.ndbm
    ...
    syn keyword schemeExtFunc gauche.let-opt
    ...
    syn keyword schemeExtFunc gauche.singleton
    ...
    syn keyword schemeExtFunc gauche.validator
    ...
    syn keyword schemeExtFunc objc-wrapper
    syn keyword schemeExtFunc readline.history
    syn keyword schemeExtFunc readline.keymap
    syn keyword schemeExtFunc readline.term-util
    ...
    syn keyword schemeExtSyntax c-enum
    set lispwords+=c-enum
    syn keyword schemeExtSyntax c-include
    set lispwords+=c-include
    syn keyword schemeExtSyntax c-load
    set lispwords+=c-load
    syn keyword schemeExtSyntax c-struct
    set lispwords+=c-struct
    syn keyword schemeExtSyntax c-union
    set lispwords+=c-union
    ...
    set lispwords+=dec!
    syn keyword schemeExtSyntax define-c-struct
    set lispwords+=define-c-struct
    syn keyword schemeExtSyntax define-c-union
    set lispwords+=define-c-union
    ...
    syn keyword schemeExtSyntax define-keys
    set lispwords+=define-keys
    syn keyword schemeExtSyntax define-objc-class
    set lispwords+=define-objc-class
    syn keyword schemeExtSyntax define-objc-method
    set lispwords+=define-objc-method
    ...
    syn keyword schemeExtSyntax with-immediate-input
    set lispwords+=with-immediate-input
    ...
    syn keyword schemeExtFunc %c-scan
    ...
    syn keyword schemeExtFunc %with-immediate-input
    ...
    syn keyword schemeExtFunc add-digit
    ...
    syn keyword schemeExtFunc backslash
    syn keyword schemeExtFunc backward-char
    syn keyword schemeExtFunc backward-word
    ...
    syn keyword schemeExtFunc beginning-of-line
    syn keyword schemeExtFunc beginning-of-subline
    ...
    syn keyword schemeExtFunc buf-next-char
    syn keyword schemeExtFunc buf-peek-char
    syn keyword schemeExtFunc buf-read-char
    syn keyword schemeExtFunc buf-read-line
    ...
    syn keyword schemeExtFunc c-array
    syn keyword schemeExtFunc c-array-length
    syn keyword schemeExtFunc c-array-ref
    syn keyword schemeExtFunc c-array-set!
    syn keyword schemeExtFunc c-bit-field
    syn keyword schemeExtFunc c-closure-free
    syn keyword schemeExtFunc c-func
    syn keyword schemeExtFunc c-func-ptr
    syn keyword schemeExtFunc c-func-vaargs-ptr
    syn keyword schemeExtFunc c-ld
    syn keyword schemeExtFunc c-load-framework
    syn keyword schemeExtFunc c-load-library
    syn keyword schemeExtFunc c-lookup-symbol
    syn keyword schemeExtFunc c-offsetof
    syn keyword schemeExtFunc c-parse
    syn keyword schemeExtFunc c-ptr+
    syn keyword schemeExtFunc c-ptr-
    syn keyword schemeExtFunc c-scan
    syn keyword schemeExtFunc c-struct-ref
    syn keyword schemeExtFunc c-struct-set!
    syn keyword schemeExtFunc c-type?
    syn keyword schemeExtFunc c-union-ref
    syn keyword schemeExtFunc c-union-set!
    ...
    syn keyword schemeExtFunc char->control
    syn keyword schemeExtFunc char->ucs
    syn keyword schemeExtFunc char-digit?
    syn keyword schemeExtFunc char-hex-digit?
    syn keyword schemeExtFunc char-nonzero-digit?
    syn keyword schemeExtFunc char-octal-digit?
    syn keyword schemeExtFunc char-set
    ...
    syn keyword schemeExtFunc compile-wrapper
    ...
    syn keyword schemeExtFunc delete!
    syn keyword schemeExtFunc delete$
    syn keyword schemeExtFunc delete-backward-char
    syn keyword schemeExtFunc delete-backward-word
    syn keyword schemeExtFunc delete-char
    ...
    syn keyword schemeExtFunc delete-keyword!
    syn keyword schemeExtFunc delete-line
    syn keyword schemeExtFunc delete-rest-of-line
    syn keyword schemeExtFunc delete-word
    ...
    syn keyword schemeExtFunc do-sharp-command
    ...
    syn keyword schemeExtFunc end-of-line
    syn keyword schemeExtFunc end-of-subline
    ...
    syn keyword schemeExtFunc erase-rest-of-line
    syn keyword schemeExtFunc error
    syn keyword schemeExtFunc error-key
    ...
    syn keyword schemeExtFunc finalize!
    ...
    syn keyword schemeExtFunc follow
    ...
    syn keyword schemeExtFunc forward-char
    syn keyword schemeExtFunc forward-word
    ...
    syn keyword schemeExtFunc get-cursor
    ...
    syn keyword schemeExtFunc get-keyword-val
    syn keyword schemeExtFunc get-operator-val
    ...
    syn keyword schemeExtFunc hash-table?
    syn keyword schemeExtFunc hexchar->integer
    syn keyword schemeExtFunc history-next
    syn keyword schemeExtFunc history-previous
    syn keyword schemeExtFunc history-store
    ...
    syn keyword schemeExtFunc init-c-enum!
    syn keyword schemeExtFunc init-c-struct!
    syn keyword schemeExtFunc init-c-union!
    ...
    syn keyword schemeExtFunc integer-range->char-set!
    syn keyword schemeExtFunc integer-suffix
    ...
    syn keyword schemeExtFunc ld-library-paths
    ...
    syn keyword schemeExtFunc main
    syn keyword schemeExtFunc make-array
    syn keyword schemeExtFunc make-bit-field
    syn keyword schemeExtFunc make-byte-string
    syn keyword schemeExtFunc make-bytes
    syn keyword schemeExtFunc make-c-array
    syn keyword schemeExtFunc make-c-func
    syn keyword schemeExtFunc make-c-func-ptr
    syn keyword schemeExtFunc make-c-func-type
    syn keyword schemeExtFunc make-c-func-vaargs
    syn keyword schemeExtFunc make-c-func-vaargs-ptr
    syn keyword schemeExtFunc make-c-var
    ...
    syn keyword schemeExtFunc make-null-ptr
    ...
    syn keyword schemeExtFunc make-super
    ...
    syn keyword schemeExtFunc mysql-close
    syn keyword schemeExtFunc mysql-errno
    syn keyword schemeExtFunc mysql-error
    syn keyword schemeExtFunc mysql-fetch-row
    syn keyword schemeExtFunc mysql-free-result
    syn keyword schemeExtFunc mysql-handle-closed?
    syn keyword schemeExtFunc mysql-real-connect
    syn keyword schemeExtFunc mysql-real-escape-string
    syn keyword schemeExtFunc mysql-real-query
    syn keyword schemeExtFunc mysql-res-closed?
    syn keyword schemeExtFunc mysql-store-result
    syn keyword schemeExtFunc name-compare
    syn keyword schemeExtFunc ndbm-clearerror
    syn keyword schemeExtFunc ndbm-close
    syn keyword schemeExtFunc ndbm-closed?
    syn keyword schemeExtFunc ndbm-delete
    syn keyword schemeExtFunc ndbm-error
    syn keyword schemeExtFunc ndbm-exists?
    syn keyword schemeExtFunc ndbm-fetch
    syn keyword schemeExtFunc ndbm-firstkey
    syn keyword schemeExtFunc ndbm-nextkey
    syn keyword schemeExtFunc ndbm-open
    syn keyword schemeExtFunc ndbm-store
    syn keyword schemeExtFunc next-line
    ...
    syn keyword schemeExtFunc null-ptr?
    syn keyword schemeExtFunc number->stream
    syn keyword schemeExtFunc objc-add-method
    syn keyword schemeExtFunc objc-lookup-class
    syn keyword schemeExtFunc objc-register-method
    ...
    syn keyword schemeExtFunc previous-line
    ...
    syn keyword schemeExtFunc read-character-constant
    syn keyword schemeExtFunc read-decimal
    syn keyword schemeExtFunc read-eval-print-loop
    syn keyword schemeExtFunc read-expnum
    syn keyword schemeExtFunc read-ext-char
    syn keyword schemeExtFunc read-ext-char:ext-function?
    syn keyword schemeExtFunc read-f16
    syn keyword schemeExtFunc read-f32
    syn keyword schemeExtFunc read-f64
    syn keyword schemeExtFunc read-flonum
    syn keyword schemeExtFunc read-from-string
    syn keyword schemeExtFunc read-hexadecimal
    syn keyword schemeExtFunc read-identifier
    syn keyword schemeExtFunc read-line
    syn keyword schemeExtFunc read-list
    syn keyword schemeExtFunc read-number-constant
    syn keyword schemeExtFunc read-octal-or-flonum
    syn keyword schemeExtFunc read-operator
    ...
    syn keyword schemeExtFunc read-string-literal
    ...
    syn keyword schemeExtFunc readline
    ...
    syn keyword schemeExtFunc register-finalizer!
    ...
    syn keyword schemeExtFunc require:provide
    syn keyword schemeExtFunc require:provided?
    syn keyword schemeExtFunc require:require
    ...
    syn keyword schemeExtFunc rot13-filter
    ...
    syn keyword schemeExtFunc s8vector-xor!
    syn keyword schemeExtFunc s8vector?
    syn keyword schemeExtFunc sc-do-sharp-space
    syn keyword schemeExtFunc sc-ignore
    ...
    syn keyword schemeExtFunc search-library-with-ldconfig
    ...
    syn keyword schemeExtFunc skip-line
    syn keyword schemeExtFunc skip-spaces
    ...
    syn keyword schemeExtFunc sys-library-paths
    ...
    syn keyword schemeExtFunc sys-sleep-ms
    ...
    syn keyword schemeExtFunc tab-insert
    ...
    syn keyword schemeExtFunc terminal-columns
    ...
    syn keyword schemeExtFunc to-column
    syn keyword schemeExtFunc to-cursor
    syn keyword schemeExtFunc toggle-reverse-input
    syn keyword schemeExtFunc toggle-rot13-filter
    ...
    syn keyword schemeExtFunc unregister-finalizer!
    ...
    syn keyword schemeExtFunc array-sub-elements!
    syn keyword schemeExtFunc c-ptr-ref
    syn keyword schemeExtFunc c-ptr-set!
    syn keyword schemeExtFunc c-sizeof
    syn keyword schemeExtFunc c-value-ref
    syn keyword schemeExtFunc c-value-set!
    syn keyword schemeExtFunc call-with-builder
    syn keyword schemeExtFunc call-with-iterator
    syn keyword schemeExtFunc cast
    ...
    syn keyword schemeExtFunc deref
    ...
    syn keyword schemeExtFunc post++
    syn keyword schemeExtFunc post--
    syn keyword schemeExtFunc pre++
    syn keyword schemeExtFunc pre--
    ...
    syn keyword schemeExtFunc ptr
    syn keyword schemeExtFunc raw-ref
    ...
    syn keyword schemeExtFunc scm-cast
    ...
    syn keyword schemeExtFunc <c-array-meta>
    syn keyword schemeExtFunc <c-array>
    syn keyword schemeExtFunc <c-basic-ptr-meta>
    syn keyword schemeExtFunc <c-basic-ptr>
    syn keyword schemeExtFunc <c-char>
    syn keyword schemeExtFunc <c-double>
    syn keyword schemeExtFunc <c-float>
    syn keyword schemeExtFunc <c-func-ptr-meta>
    syn keyword schemeExtFunc <c-func-ptr>
    syn keyword schemeExtFunc <c-func>
    syn keyword schemeExtFunc <c-int>
    syn keyword schemeExtFunc <c-long>
    syn keyword schemeExtFunc <c-longdouble>
    syn keyword schemeExtFunc <c-longlong>
    syn keyword schemeExtFunc <c-ptr-meta>
    syn keyword schemeExtFunc <c-ptr>
    syn keyword schemeExtFunc <c-short>
    syn keyword schemeExtFunc <c-struct-meta>
    syn keyword schemeExtFunc <c-struct>
    syn keyword schemeExtFunc <c-type-meta>
    syn keyword schemeExtFunc <c-type>
    syn keyword schemeExtFunc <c-uchar>
    syn keyword schemeExtFunc <c-uint>
    syn keyword schemeExtFunc <c-ulong>
    syn keyword schemeExtFunc <c-ulonglong>
    syn keyword schemeExtFunc <c-union-meta>
    syn keyword schemeExtFunc <c-union>
    syn keyword schemeExtFunc <c-ushort>
    syn keyword schemeExtFunc <c-value-meta>
    syn keyword schemeExtFunc <c-value>
    syn keyword schemeExtFunc <c-void-meta>
    syn keyword schemeExtFunc <c-void>
    syn keyword schemeExtFunc <cgen-literal>
    ...
    syn keyword schemeExtFunc <module>
    syn keyword schemeExtFunc <mutex>
    syn keyword schemeExtFunc <mysql-connection>
    syn keyword schemeExtFunc <mysql-driver>
    syn keyword schemeExtFunc <mysql-handle>
    syn keyword schemeExtFunc <mysql-res>
    syn keyword schemeExtFunc <mysql-result-set>
    syn keyword schemeExtFunc <ndbm>
    ...
    syn keyword schemeExtFunc <sockaddr-in6>
    ...
    syn keyword schemeExtFunc <sys-addrinfo>
    syn keyword schemeExtFunc <sys-fdset>
    ...
    syn keyword schemeExtFunc identifier-charset
    syn keyword schemeExtFunc initial-identifier-charset
    syn keyword schemeExtFunc operator-charset
    syn keyword schemeExtFunc scheme-token-charset
    syn keyword schemeExtFunc special-operator-charset

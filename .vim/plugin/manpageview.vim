...
com! -nargs=* -count=0	TMan let g:manpageview_winopen="tsplit"|call s:ManPageView(0,<count>,<f-args>)
...
"  call Dfunc("ManPageView(viamap=".a:viamap." bknum=".a:bknum.") a:0=".a:0)
  ...
  if a:0 > 0
   " fix topic
"   call Decho("case a:0 > 0: fix topic (a:1<".a:1.">)")
   if &ft != "info"
	if a:0 == 2 && bknum > 0
	 let bknum = bknum.a:1
	 let topic = a:2
...
"   call Decho("attempt to infer on filetype<".&ft.">")
   ...
   if &ft == "vim"
	...
	elseif g:manpageview_winopen == "hsplit="
   	 exe "help ".manpagetopic
	 wincmd =
	elseif g:manpageview_winopen == "tsplit"
	 tabnew
   	 exe "help ".manpagetopic
	else
   	 exe "help ".manpagetopic
...
"   call Dret("ManPageView : manpageview_winopen<".g:manpageview_winopen."> not supported")
  ...
  " add some maps for multiple manpage handling
...
"	  call Decho("(nospace) exe silent! ".cmdmod."r!".pgm.iopt.manpagebook.manpagetopic)
      exe cmdmod."r!".pgm.iopt.manpagebook.manpagetopic.s:iconv
     elseif has("win32")
